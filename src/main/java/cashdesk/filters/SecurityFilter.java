package cashdesk.filters;

import cashdesk.controller.UserRole;
import cashdesk.model.entity.Users;
import cashdesk.utils.AppUtils;
import cashdesk.utils.Security;
...
public class SecurityFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain)
        ...
        if (loginedUser != null) {
            ...
            wrapRequest = new UserRole(userName, roles, request);
        }
