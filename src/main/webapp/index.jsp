...
<section id="service" class="parallax-section">
     <div class="container">
          <div class="row">
               ...
               <a href="${pageContext.request.contextPath}/key/cashier" name="role">
              ...
              <a href="${pageContext.request.contextPath}/key/adminCaisher" name="role">
                ...
                <a href="${pageContext.request.contextPath}/key/supervisor" name="role">
